          ...
          <div className="lg:w-1/2">
            <div className="space-y-6">
              ...
              <div className="p-4 bg-blue-50 border-l-4 border-[#000e54] rounded">
                <p className="font-semibold text-[#000e54]">
...
<section id="gpstracking-features" className="py-8 max-w-6xl mx-auto p-4">
      <div className="container mx-auto px-4">
        {/* Main Header */}
        <div className="text-center mb-16">
       ...
       c85.6-45.8,180-68.3,269-36.1c91.9,33.2,159.3,120.3,156.9,221.2C673.5,422.9,542.5,525.7,435.7,566.7z" fill="currentColor"/>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-white rounded-2xl shadow-xl p-8 overflow-hidden relative">
            <div className="relative z-10">
              <h3 className="text-4xl font-semibold text-gray-900 mb-6">See the Difference</h3>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Replace guesswork with analytics-powered insights</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className={`bg-${featureCategories[activeTab].color}-100 p-2 rounded-full mr-4`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Provide accurate ETAs and responsive service</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className={`bg-${featureCategories[activeTab].color}-100 p-2 rounded-full mr-4`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Cut fuel, maintenance, and labor expenses</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className={`bg-${featureCategories[activeTab].color}-100 p-2 rounded-full mr-4`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Protect drivers and reduce liability risks</p>
                  </div>
                </li>
              </ul>
            </div>
  ...
  <div className="p-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="flex items-start">
        ...
        <div>
          <h4 className="font-semibold text-gray-800 mb-2">Real-Time Location Tracking</h4>
      ...
      <div className="flex items-start">
        ...
        <div>
          <h4 className="font-semibold text-gray-800 mb-2">Geofencing Alerts</h4>
          <p className="text-gray-800">
      ...
      <div className="flex items-start">
        ...
        <div>
          <h4 className="font-semibold text-gray-800 mb-2">Driver Safety Monitoring</h4>
          <p className="text-gray-800">
...
{/* methodology */}
<div id="gps-methodology" className="py-10 max-w-6xl mx-auto p-4">
      {/* Header */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-10 space-y-6">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-lg text-gray-800">Advanced GPS tracking devices installed in vehicles capture location, speed, fuel consumption, and engine diagnostics.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-gray-900">Secure Data Transmission</h4>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-gray-900">Intelligent Data Processing</h4>
        ...
        {/* Process Flow */}
        <div className="mt-24">
          <h3 className="text-2xl font-semibold text-gray-900 text-center mb-20">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="mt-8 space-y-6">
                <div className="border-l-4 border-[#000e54] pl-4">
                  <h4 className="text-lg font-semibold text-gray-900">User Interface Layer</h4>
                ...
                <div className="border-l-4 border-[#000e54] pl-4">
                  <h4 className="text-lg font-semibold text-gray-900">API Layer</h4>
                ...
                <div className="border-l-4 border-[#000e54] pl-4">
                  <h4 className="text-lg font-semibold text-gray-900">Processing Layer</h4>
                ...
                <div className="border-l-4 border-[#000e54] pl-4">
                  <h4 className="text-lg font-semibold text-gray-900">Data Layer</h4>
...
<section id="gpstracking-howchoose" className=" py-10 max-w-7xl mx-auto p-4 ">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-4xl font-semibold text-center text-gray-900 mb-12">
        ...
        <div className="flex flex-col lg:flex-row lg:h-[350px] items-center bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">1. Assess Your Fleet Needs</h3>
            <p className="text-gray-800 mb-4">Determine what features are essential for your operations:</p>
        ...
        <div className="flex flex-col lg:flex-row-reverse lg:h-[350px] items-center bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">2. Compare Hardware Options</h3>
            <p className="text-gray-800 mb-4">Different GPS devices offer varying capabilities:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:h-[350px] bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">3. Evaluate Software Features</h3>
            <p className="text-gray-800 mb-4">Look for these critical software capabilities:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
        ...
        <div className="flex flex-col lg:flex-row-reverse lg:h-[350px] items-center bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">4. Consider Reliability & Support</h3>
            <p className="text-gray-800 mb-4">Essential service factors to evaluate:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:h-[350px] bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">5. Analyze Pricing Structure</h3>
            <p className="text-gray-800 mb-4">Understand the total cost of ownership:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center lg:h-[350px] bg-white rounded-xl shadow-lg overflow-hidden mb-12">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">6. Check Integration Capabilities</h3>
            <p className="text-gray-800 mb-4">Ensure compatibility with your existing tools:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:h-[350px] bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="w-full lg:w-1/2 p-8">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">7. Test Before Committing</h3>
            <p className="text-gray-800 mb-4">Always evaluate before full implementation:</p>
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
...
{/* alternative */}
<section id="gps-alternative" className="py-10 max-w-7xl mx-auto p-4 ">
      <div className="container mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-4xl font-semibold text-gray-900 mb-4">
